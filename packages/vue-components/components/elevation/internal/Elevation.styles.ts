...
export const sharedElevationStyles = `
    :host,
    .surface {
    ...
    .surface::after {
        ...
        box-shadow: 0px var(--y) var(--blur) var(--spread) ${makeVarWithDefault([elevationTokensExtern.color, elevationTokens.color], tokens.color.shadow.shadow)};
    }
    .surface::before {
        content: "";
        inset: 0;
        ...
        box-shadow: 0px var(--y) var(--blur) 0px ${makeVarWithDefault([elevationTokensExtern.color, elevationTokens.color], tokens.color.shadow.shadow)};
    }
`
